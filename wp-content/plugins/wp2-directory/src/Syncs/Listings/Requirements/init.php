<?php
// File: wp-content/plugins/wp2-directory/src/Syncs/Listings/Requirements/init.php

namespace WP2_Directory\Syncs\Listings\Requirements;
...
class Controller
{
     ...
     * @var string
     */
    private $hook = 'wp2_directory_trigger_requirements_sync';
     ...
     * @var string
     */
    private $callback = 'wp2_directory_execute_requirements_sync';

    /**
     * Post type for plugin listings.
     *
     * @var string
     */
     ...
     * @var string
     */
    private $catalog_dir = WP_CONTENT_DIR . '/plugins/wp2-directory/src/Catalogs/Requirements';
    ...
    public function handle_sync(): void
    {
        if ($this->check_context()) {
            ...
            $admin_notice = [
                'type'            => 'info',
                'message'         => 'Syncing Asset Listings...',
                'is_dismissible'  => true,
...
/**
 * Scheduled callback function for asset sync.
 *
 * This function is hooked to the async action.
 */
function wp2_directory_execute_requirements_sync(): void
{
    $controller = new Controller();
    $controller->execute_sync();
}

add_action('wp2_directory_trigger_requirements_sync', __NAMESPACE__ . '\\wp2_directory_execute_requirements_sync');
