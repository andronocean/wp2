<?php
// File: wp-content/plugins/wp2-directory/src/Syncs/Listings/Blocks/init.php

namespace WP2_Directory\Syncs\Listings\Blocks;
...
class Controller
{
     ...
     * @var string
     */
    private $hook = 'wp2_directory_trigger_blocks_sync';
     ...
     * @var string
     */
    private $callback = 'wp2_directory_execute_blocks_sync';
     ...
     * @var string
     */
    private $catalog_dir = WP_CONTENT_DIR . '/plugins/wp2-directory/src/Catalogs/Blocks';
 ...
 */
function wp2_directory_execute_blocks_sync(): void
{
    $controller = new Controller();
    $controller->execute_sync();
}

add_action('wp2_directory_trigger_blocks_sync', __NAMESPACE__ . '\\wp2_directory_execute_blocks_sync');
