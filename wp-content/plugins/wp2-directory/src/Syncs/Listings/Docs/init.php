<?php
// File: wp-content/plugins/wp2-directory/src/Syncs/Listings/Docs/init.php

namespace WP2_Directory\Syncs\Listings\Docs;
...
class Controller
{
     ...
     * @var string
     */
    private $hook = 'wp2_directory_trigger_docs_sync';
     ...
     * @var string
     */
    private $callback = 'wp2_directory_execute_docs_sync';
     ...
     * @var string
     */
    private $catalog_dir = WP_CONTENT_DIR . '/plugins/wp2-directory/src/Catalogs/Docs';
 ...
 */
function wp2_directory_execute_docs_sync(): void
{
    $controller = new Controller();
    $controller->execute_sync();
}

add_action('wp2_directory_trigger_docs_sync', __NAMESPACE__ . '\\wp2_directory_execute_docs_sync');
