<?php
// File: wp-content/plugins/wp2-directory/src/Syncs/Listings/Extensions/init.php

namespace WP2_Directory\Syncs\Listings\Extensions;
...
class Controller
{
     ...
     * @var string
     */
    private $hook = 'wp2_directory_trigger_extensions_sync';
     ...
     * @var string
     */
    private $callback = 'wp2_directory_execute_extensions_sync';
     ...
     * @var string
     */
    private $catalog_dir = WP_CONTENT_DIR . '/plugins/wp2-directory/src/Catalogs/Extensions';
 ...
 */
function wp2_directory_execute_extensions_sync(): void
{
    $controller = new Controller();
    $controller->execute_sync();
}

add_action('wp2_directory_trigger_extensions_sync', __NAMESPACE__ . '\\wp2_directory_execute_extensions_sync');
