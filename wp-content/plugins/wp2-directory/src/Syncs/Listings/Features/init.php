<?php
// File: wp-content/plugins/wp2-directory/src/Syncs/Listings/Features/init.php

namespace WP2_Directory\Syncs\Listings\Features;
...
class Controller
{
     ...
     * @var string
     */
    private $hook = 'wp2_directory_trigger_features_sync';
     ...
     * @var string
     */
    private $callback = 'wp2_directory_execute_features_sync';
     ...
     * @var string
     */
    private $catalog_dir = WP_CONTENT_DIR . '/plugins/wp2-directory/src/Catalogs/Features';
 ...
 */
function wp2_directory_execute_features_sync(): void
{
    $controller = new Controller();
    $controller->execute_sync();
}

add_action('wp2_directory_trigger_features_sync', __NAMESPACE__ . '\\wp2_directory_execute_features_sync');
